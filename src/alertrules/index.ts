// https://www.terraform.io/docs/providers/zenduty/r/alertrules
...
export interface AlertrulesConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  */
  readonly actions?: AlertrulesActions[] | cdktf.IResolvable;
}
export interface AlertrulesActions {
  /**
...
export function alertrulesActionsToTerraform(struct?: AlertrulesActions | cdktf.IResolvable): any {
...
export class AlertrulesActionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AlertrulesActions | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: AlertrulesActions | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class AlertrulesActionsList extends cdktf.ComplexList {
  public internalValue? : AlertrulesActions[] | cdktf.IResolvable
  ...
  */
  public get(index: number): AlertrulesActionsOutputReference {
    return new AlertrulesActionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
*/
export class Alertrules extends cdktf.TerraformResource {
  ...
  /**
  * Create a new {@link https://www.terraform.io/docs/providers/zenduty/r/alertrules zenduty_alertrules} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options AlertrulesConfig
  */
  public constructor(scope: Construct, id: string, config: AlertrulesConfig) {
    super(scope, id, {
  ...
  private _actions = new AlertrulesActionsList(this, "actions", false);
  public get actions() {
    return this._actions;
  }
  public putActions(value: AlertrulesActions[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      actions: cdktf.listMapper(alertrulesActionsToTerraform, true)(this._actions.internalValue),
    };
  }
}
