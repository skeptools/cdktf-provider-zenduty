...
| <code><a href="#@skeptools/provider-zenduty.invite.Invite.property.count">count</a></code> | <code>number</code> | *No description.* |
...
| <code><a href="#@skeptools/provider-zenduty.invite.InviteConfig.property.count">count</a></code> | <code>number</code> | *No description.* |
...
| <code><a href="#@skeptools/provider-zenduty.invite.InviteEmailAccountsOutputReference.property.internalValue">internalValue</a></code> | <code><a href="#@skeptools/provider-zenduty.invite.InviteEmailAccounts">InviteEmailAccounts</a> \| cdktf.IResolvable</code> | *No description.* |
...
```typescript
public readonly internalValue: InviteEmailAccounts | IResolvable;
```

- *Type:* <a href="#@skeptools/provider-zenduty.invite.InviteEmailAccounts">InviteEmailAccounts</a> | cdktf.IResolvable
